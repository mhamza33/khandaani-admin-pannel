  ...
  return (
    <div className="customerdata">
      <div className="customerImage">
        ...
        <p style={{marginTop: '5px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
          Verified{" "}&nbsp;
          <span >
            {" "}
            <MdVerified
      ...
      <div>
        ...
        <div style={{width: '100%', margin: '0px',display: 'flex', justifyContent: 'flex-end', color: 'rgb(40, 125, 252)'}}>
          <p style={{textDecoration: 'underline', fontSize: '8px', margin: '0px'}}>Other documents</p>
        </div>
        <hr />
        <Row style={{ margin: "0px" }}>
          <Col
